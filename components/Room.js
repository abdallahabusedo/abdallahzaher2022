...
export default function Scene({ ...props }) {
  const { nodes, materials } = useSpline(
    "https://prod.spline.design/AqaVuMhQ6L8yAIkB/scene.splinecode"
  );
  return (
    <>
      <group {...props} dispose={null}>
        <PerspectiveCamera
          ...
          fov={45}
          up={[0, 1, 0]}
          position={[-1941.12, 1267.34, 3011.52]}
          rotation={[-0.41, -0.54, -0.22]}
          scale={1}
        />
        <directionalLight
          ...
          position={[0, 729.52, -42.59]}
          scale={0.66}
        />
        <group name="Group" position={[0, 0, 6.07]}>
          <mesh
            name="Walls"
            ...
            scale={0.46}
          />
          <group name="Objects" position={[0, -31.96, 1.77]} scale={0.66}>
            <mesh
              name="Sphere"
